...
export const metadata: Metadata = {
  ...
  description: "Tradução e dublagem comunitária das vozes do Dota 2 em português brasileiro.",
  icons: { icon: "/og.png", shortcut: "/og.png" },
  openGraph: {
    title: "Dota 2 Translate PT-BR",
    description: "Cada herói. Cada fala. Uma dublagem brasileira construída em público.",
    locale: "pt_BR",
    type: "website",
    images: ["/og.png"],
  },
