    ...
    <>
      ...
      <main className="page-shell">
        <div className="page-intro">
          ...
          <p>Inglês oficial e PT-BR reunidos na mesma lista. A origem segue a prioridade oficial, comunidade e automática; usuários Steam podem sugerir alterações em cada linha.</p>
        </div>
